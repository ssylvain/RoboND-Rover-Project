...
def perception_step(Rover):
    ...
    Rover.vision_image[:,:,1] = rock_map
    Rover.vision_image[:,:,2] = img_threshed
    ...
    Rover.worldmap[obs_y_pix_world, obs_x_pix_world, 0] = 255
    nav_pix = Rover.worldmap.worldmap[:,:,2] > 0
